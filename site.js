document.addEventListener('DOMContentLoaded', function() {
    ...
    async function sendEmailReport(devices) {
        ...
        // Ändra event listener för bekräfta knappen
    ...
    // Observera att vi behöver skapa Email-knappen efter rapporten genereras
    // Därför lägger vi till detta i generateReport-funktionen

    // Ändra generateReport-funktionen för att skapa Email-knappen
    async function generateReport(siteData, siteName) {
        const cameras = siteData[siteName].hardware;
        let reportHTML = `<h3>Testrapport för Site: ${siteName}</h3><br/>`;
